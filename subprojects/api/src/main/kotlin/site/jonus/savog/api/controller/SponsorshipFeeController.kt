...
class SponsorshipFeeController(private val sponsorshipFeeService: SponsorshipFeeService) : BaseController() {
    ...
    @GetMapping("/sponsorshipFees/{petId}", name = "세이보그 유기동물 후원금 조회")
    ...
    @PostMapping("/sponsorshipFees", name = "세이보그 유기동물 후원금 등록")
    ...
    @PutMapping("/sponsorshipFees", name = "세이보그 유기동물 후원금 수정")
    ...
    @DeleteMapping("/sponsorshipFees", name = "세이보그 유기동물 후원금 삭제")
