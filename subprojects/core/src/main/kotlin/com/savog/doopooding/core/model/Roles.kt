...
object Roles : LongIdTable("role", "id") {
    /**
     * 회원ID
     */
...
class Role(id: EntityID<Long>) : LongEntity(id) {
    var userId: Long by Roles.userId

    var role: String by Roles.role

    var deleted: Int by Roles.deleted

    var creatorId: String by Roles.creatorId

    var updaterId: String by Roles.updaterId

    val createdAt: Instant by Roles.createdAt

    val updatedAt: Instant by Roles.updatedAt
